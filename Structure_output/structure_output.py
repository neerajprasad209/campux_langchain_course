...
srtuctured_model = model.with_structured_output(StructureOutput)

result = srtuctured_model.invoke("""
                        ...
                        The S-Pen integration is a great touch for note-taking and quick sketches, though I don't use it often. What really blew 
                        me away is the 200MP camera—the night mode is stunning, capturing crisp, vibrant images even in low light. Zooming up to 
